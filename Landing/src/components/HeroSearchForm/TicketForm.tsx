    ...
    return (
      <div className="flex mt-3 items-center">
        <input
          ...
          onChange={(e) => {
            components[index][arrIndex] = e.target.checked;
      ...
      return (
        <div
          className={`flex flex-col lg:flex-row lg:space-x-4 space-y-3 lg:space-y-0 ${
            windowSize.width > 1400 ? "items-end" : ""
          }`}
        >
        ...
        <div className="flex-row flex justify-end">
          ...
          >
            <div className="mr-2 text-gray-500 cursor-pointer flex justify-end">
              <span className="">
                {"Valor Final R$" + (valor + taxa(valor) - abs).toFixed(2)}
              </span>
              <svg
                aria-haspopup="true"
            ...
            {obj[8] === 1 && (
              ...
              >
                <span className="px-3 shadow-lg rounded-2xl bg-white border border-neutral-200 text-neutral-700 dark:bg-neutral-900 dark:text-neutral-300 dark:border-neutral-700">
                  Preço: R${(valor - abs).toFixed(2)} + Taxa: R$
  ...
  const renderForm = () => {
    return (
      <CommonLayout className="w-full" index="3. Ingressos">
        ...
        <div
          className={`grid  ${
            windowSize.width > 1400 ? "grid-cols-2 gap-5" : "grid-cols-1"
          ...
          {components.map((item, i) => (
            <div className="relative flex-shrink-0 items-center">
              ...
              <CommonLayout
                className="w-full"
                index={
                  components[i][0].toString().length > 0
                    ? components[i][0].toString()
                    : i + 1 + "° Ingresso"
                }
              >
                {/*Ticketform*/}
                  ...
                  <div className="flex flex-col lg:flex-row lg:space-x-4 space-y-3 lg:space-y-0 items-strech">
                    <FormItem label="Nome do Ingresso" className="">
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setComponents([...components]);
                          setLote([...lote, components[i][0].toString()]);
                        }}
                      />
                    </FormItem>
                    <div>
                      ...
                      <div className="mt-2">
                        <div className="relative">
                          ...
                          <Input
                            ...
                            step=".01"
                            onChange={(e) => {
                              item[1] = e.target.valueAsNumber;
                              item[6] = e.target.valueAsNumber / 2;
                              setComponents([...components]);
                            }}
                          />
                        </div>
                    ...
                    <FormItem label="Quantidade" className="col-span-2">
                      <Input
                        ...
                        type="number"
                        onChange={(e) => {
                          components[i][2] = e.target.valueAsNumber;
                          setComponents([...components]);
                        }}
                      />
                    </FormItem>
                  ...
                  >
                    <TicketDatesRangeInput
                      ...
                      wrapFieldClassName={`w-full mt-2 relative flex flex-col md:flex-row md:items-center 
                        ...
                        components[i][7] ? "hidden" : ""
                      }`}
                      onChange={(data) => {
                        components[i][10] = data.stateDate;
                        components[i][11] = data.stateTimeRage;
                        setComponents([...components]);
                      }}
                      anchorDirection={
                        windowSize.width > 1400 ? "left" : "right"
                      }
                    />
                    <div
                    ...
                    >
                      <div
                        className={windowSize.width > 1400 ? "w-1/2" : "hidden"}
                      >
                        <ListInput
                          defaultValue={components[i][9]}
                          onChange={(e) => {
                            components[i][9] = e;
                            setComponents([...components]);
                          }}
                ...
                >
                  <Textarea
                    ...
                    rows={5}
                    onChange={(e) => {
                      components[i][14] = e.target.value;
                      setComponents([...components]);
                    }}
                  />
                </FormItem>
